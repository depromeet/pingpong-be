...
public class MemberControllerTest extends RestDocsTestSupport {
    ...
    @Test
    void 로그인한_사용자를_조회한다() throws Exception {
        Long loginMemberId = Long.valueOf(MEMBER_ID);
        MemberRankReadResponse memberRankReadResponse = new MemberRankReadResponse(
            22L,
            "김감자",
            "https://dpm-pingpong-bucket.s3.ap-northeast-2.amazonaws.com/member1/profileImage/be8ffde534364dac907ae9b32e93b859-kirby.png",
            "안녕하세요",
            "루키",
            "rank/rookie.png",
            "0",
        ...
        given(memberQueryService.readMemberInfo(loginMemberId)).willReturn(memberRankReadResponse);
